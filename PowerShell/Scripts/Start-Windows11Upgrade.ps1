...
.GUID d68046c2-5895-4fae-a03c-61795d9f32b2
...
if ($isSystemEligibleForUpgrade -or $Force) {
    ...
    $driveType = 3
    $diskInfo = Get-WmiObject -Class Win32_LogicalDisk -ComputerName LOCALHOST | Where-Object { ($_.DriveType -eq $driveType) -and ($_.DeviceID -eq $systemDrive) } | Select-Object -Property $properties
